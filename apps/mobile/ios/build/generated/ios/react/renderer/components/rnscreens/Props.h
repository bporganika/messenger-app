...
enum class RNSModalScreenStackAnimation { Default, Flip, Simple_push, None, Fade, Slide_from_right, Slide_from_left, Slide_from_bottom, Fade_from_bottom, Ios, Ios_from_right, Ios_from_left };
...
enum class RNSSearchBarAutoCapitalize { None, Words, Sentences, Characters, SystemDefault };
